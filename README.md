...
> 변화가 빠른 세상에서 바닥부터 쌓아올리는 건 너무 느립니다. 먼저 만들고, 부딪히고, 그때 필요한 지식을 깊이 파는 생존을 위한 Top-Down 어프로치입니다.
...
|-------|-----------|-----------|
| 🛠 S1 | 화면에 뭔가를 띄우고 싶습니다 | SwiftUI, 상태 관리, Swift 기초 |
| 🐢 S2 | 앱이 느립니다 | 자료구조, 알고리즘, Big-O |
| 🍝 S3 | 코드가 스파게티가 됐습니다 | OOP, SOLID, 디자인 패턴, 아키텍처 |
| 💀 S4 | 앱이 죽습니다 | ARC, 메모리 관리, 에러 처리 |
